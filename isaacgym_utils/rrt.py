...
class RRT:
    ...
    def __init__(self, fr, is_in_collision):
        ...
        self._q_step_size = 0.1  # Default: 0.01
        self._target_p = 0.7  # Default: 0.3
    ...
    def sample_valid_joints(self):
        ...
        q = (self._fr.joint_limits_upper[:7] - self._fr.joint_limits_lower[:7]) * np.random.random(self._fr.num_dof) + self._fr.joint_limits_lower[:7]
        return q
