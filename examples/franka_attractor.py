...
# # parser.add_argument('--cfg', '-c', type=str, default='cfg/franka_tree.yaml')argparse
...
# tree_asset = gym.load_asset(
#     sim, asset_root, franka_asset_file, asset_options)
# tree = GymTree(cfg['tree'])
...
for i in range(num_envs):
    ...
    # tree_handle = gym.create_actor(env, tree, tree_transform, "tree", i, 2)
