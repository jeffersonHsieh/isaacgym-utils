...
def import_tree(name_dict, urdf_path, yaml_path, edge_def, point_data):
    ...
    def save_data(five_sec_counter):
    ...
    def policy(scene, env_idx, t_step, t_sim):
        ...
        if five_sec_interval > 3:
            if no_contact == True:
                ...
                contact_name = tree.link_names[random_index]
